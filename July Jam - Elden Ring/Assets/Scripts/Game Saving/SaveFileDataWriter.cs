...
public class SaveFileDataWriter
{
    ...
    //BEFORE WE CREATE A NEW SAVE FILE, WE NUST CHECK TO SEE IF ONE OF THIS CHARACTER SLOTS ALREADY EXUST (MAX 10 CHARACTER SLOTS)
    ...
    public CharacterSaveData LoadSaveFile(){
        ...
        if(File.Exists(loadPath)){
            ...
            try{
                ...
                //DESERIALIZE THE DATA BACK FROM JSON TO UNITY
